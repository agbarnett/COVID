...
# generates initial state for individuals
# April 2020
...
#  s2 <- '0' # ifelse(age<=18, fert[1], sample(fert, 1)) # not needed
  s3 <- 'S' # alternative version, start with all susceptible 
#  s3 <- sample(c("S","E",'I1'), size=1, prob = starting.probs) # random starting
# 
